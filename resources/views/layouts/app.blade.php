...
<head>
    ...
    <style>
        ...
        .brand{color:#fff;margin-left:-4px;align-items:center;align-self:center;width:180px;height:55px;overflow:hidden;position:relative;background:url('{{ asset('images/mekatos-logo.png') }}') center/cover no-repeat;flex-shrink:0}
        .brand-mark,.brand>span{display:none!important}
        ...
        .logout-form{position:absolute;right:0;top:calc(100% + 7px);min-width:185px;padding:5px;background:var(--mk-card);border:1px solid var(--mk-border);border-radius:10px;box-shadow:0 12px 30px rgba(70,18,18,.22);z-index:50;display:none}.user-menu.open .logout-form{display:block}.nav-logout{width:100%;border:0;border-radius:7px;background:transparent;color:var(--mk-red-dark);padding:9px 11px;text-align:left;cursor:pointer;font:inherit;font-weight:700}.nav-logout:hover,.nav-logout:focus-visible{background:var(--mk-red-soft);color:var(--mk-red-dark);outline:none}.nav-settings{display:block;width:100%;box-sizing:border-box;border-radius:7px;background:transparent;color:var(--mk-red-dark);padding:9px 11px;text-decoration:none;font:inherit;font-weight:700}.nav-settings:hover,.nav-settings:focus-visible{background:var(--mk-red-soft);color:var(--mk-red-dark);outline:none}
        .main-nav .nav-settings{color:var(--mk-red-dark)!important}.main-nav .nav-logout{color:var(--mk-red-dark)!important}
        .mobile-nav-toggle{border-color:rgba(255,255,255,.35);background:var(--mk-red-dark);color:#fff}.main-nav{row-gap:5px}.mobile-nav-toggle{align-items:center;gap:5px}
        ...
        .panel,.form-card{background:var(--mk-card);border-color:var(--mk-border);box-shadow:0 9px 28px rgba(83,58,15,.10)}.panel-header{border-bottom-color:#eadfbf}.panel-header h3{color:var(--mk-ink)}.panel-header span{color:var(--mk-muted)}
        ...
        .button-primary{background:var(--mk-red);border-color:var(--mk-red);color:#fff;box-shadow:0 3px 8px rgba(122,25,25,.20)}.button-primary:hover{background:var(--mk-red-dark);color:#fff}.button-danger{border-color:#e1aaaa;color:var(--mk-red-dark);background:#fff8f7}.button-danger:hover{background:#ffeceb}
        ...
        .alert-success{background:#edf7e8;border-color:#b9d9a9;color:#315d24}.alert-error{background:#fff0ef;border-color:#e3b0ad;color:#8f2527}.empty-state{color:#6f6254}.empty-state h3{color:var(--mk-ink)}
