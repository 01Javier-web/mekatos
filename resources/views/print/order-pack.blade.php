...
<head>
    ...
    <style>
        *{box-sizing:border-box}html,body{margin:0;padding:0;background:#fff;color:#111;font-family:Arial,Helvetica,sans-serif}.print-actions{padding:18px;text-align:center}.print-actions button{padding:10px 16px;border:0;border-radius:8px;background:#111;color:#fff;font-weight:700;cursor:pointer}.tickets{width:80mm;margin:0 auto}.ticket{width:100%;padding:5mm 3mm}.ticket+.ticket{border-top:1px dashed #777}.ticket h1{text-align:center;font-size:18px;margin:0 0 7px;text-transform:uppercase}.ticket .location{text-align:center;font-size:15px;font-weight:800;margin-bottom:8px}.ticket .meta{font-size:11px;line-height:1.45;margin-bottom:9px}.ticket .meta strong{font-weight:800}.line{display:flex;justify-content:space-between;gap:8px;margin:7px 0;font-size:13px;font-weight:700}.line-name{min-width:0}.line-note{font-size:11px;font-weight:500;margin:2px 0 7px 0;padding-left:10px;line-height:1.35}.general-note{border-top:1px dashed #777;margin-top:9px;padding-top:8px;font-size:11px;line-height:1.4}.general-note strong{display:block;text-transform:uppercase;margin-bottom:3px}.empty-ticket{font-size:11px;text-align:center;padding:10px 0}.cut{height:8mm;border-top:1px dashed #777;margin:0 3mm}@media print{.print-actions{display:none}.tickets{width:80mm}.ticket{break-after:page}.ticket:last-child{break-after:auto}.cut{display:none}@page{size:80mm auto;margin:0}}
    </style>
</head>
<body>
