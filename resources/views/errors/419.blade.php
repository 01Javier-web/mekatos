...
<head>
    ...
    <title>Sesión expirada | Mekatos</title>
...
<main class="error-page">
    <div class="error-card">
        ...
        <strong class="error-code">419</strong>
        <h1>Tu sesión expiró</h1>
        <p>Por seguridad, esta página necesita una sesión nueva. Vuelve a intentarlo.</p>
        <a class="button button-primary" href="{{ url()->previous() !== url()->current() ? url()->previous() : url('/') }}">Intentar de nuevo</a>
    </div>
</main>
<style>
