...
<head>
    ...
    <title>Error del servidor | Mekatos</title>
...
<main class="error-page">
    <div class="error-card">
        ...
        <strong class="error-code">500</strong>
        <h1>Algo salió mal</h1>
        <p>Ocurrió un problema inesperado. Puedes volver al inicio e intentar nuevamente.</p>
