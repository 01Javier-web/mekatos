...
<div class="page-shell page-shell-narrow">
    ...
    <div class="order-detail-grid">
        <section class="panel"><div class="panel-header"><h3>Acciones</h3><span>El pedido sigue el flujo operativo de Mekatos.</span></div><div class="detail-body actions-stack">
            ...
            @if($order->status === \App\Enums\OrderStatus::PREPARING)<p class="muted">El pedido está en preparación. El mesero lo marcará como ENTREGADO cuando lo lleve a la mesa.</p>@endif
