...
<div class="page-shell page-shell-narrow">
    ...
    <div class="order-detail-grid">
        <section class="panel"><div class="panel-header"><h3>Estado del pedido</h3><span>Estado actual: {{ $order->status->value }}</span></div><div class="detail-body">
...
<style>.order-meta{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:20px 0}.order-meta>div{padding:12px;border:1px solid #e7e7e4;border-radius:10px;background:#fafaf8}.order-meta span{display:block;color:#777;font-size:.74rem;margin-bottom:3px}.order-meta strong{font-size:.88rem}@media(max-width:560px){.order-meta{grid-template-columns:1fr}}</style>
@endsection
