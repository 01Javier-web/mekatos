...
<div class="page-shell page-shell-narrow">
    ...
    <form class="form-card product-form" method="POST" action="{{ route('admin.settings.products.update', $product) }}">
        ...
        @if ($product->name === 'Jugo Natural Jarra')
            <section class="juice-settings-card">
                <div class="form-section-title"><strong>Configuración del jugo</strong><span>Controla las frutas disponibles para nuevos pedidos.</span></div>
                <p class="field-help juice-settings-description">Si una fruta se agota, puedes desactivarla aquí. Dejará de aparecer en el selector del pedido por QR.</p>
