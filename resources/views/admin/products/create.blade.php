...
<div class="page-shell page-shell-narrow">
    <div class="page-heading"><div><span class="eyebrow">Configuración</span><h2>Nuevo producto</h2><p>Agrega un producto al menú de Mekatos.</p></div><a class="button" href="{{ route('admin.settings.products.index') }}">← Volver</a></div>
    ...
    <form class="form-card product-form" method="POST" action="{{ route('admin.settings.products.store') }}">
        @csrf
