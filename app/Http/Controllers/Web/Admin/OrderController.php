...
class OrderController extends Controller
{
    ...
    {
        $orders = Order::query()
            ->with(['tableSession.restaurantTable', 'orderItems.product', 'handledBy'])
    ...
    public function pending(): JsonResponse
    {
        $orders = Order::query()
            ...
            ->with(['tableSession.restaurantTable', 'handledBy'])
            ->oldest()
            ->get();
        ...
        return response()->json([
            ...
            'orders' => $orders->map(fn (Order $order) => [
                'id' => $order->id,
                'location' => $order->type?->value === 'PARA_LLEVAR'
                    ? 'PARA LLEVAR'
                    : 'MESA '.($order->tableSession?->restaurantTable?->number ?? '—'),
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $itemsValidator = validator(['items' => $validated['items']], [
